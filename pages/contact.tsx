      ...
      <div className="h-3/4 bg-black flex flex-col items-center justify-center relative w-2/3 border-solid border-2 border-black
        ...
        <div className="absolute top-0 left-0 right-0 flex flex-col h-full w-full pt-4 px-4 bg-white mix-blend-difference items-center">
          <div className="w-full relative mt-2 px-2">
            <h1 className="text-7xl text-black font-integralbold -translate-y-2 z-50 sm:text-8xl sm:mt-8 sm:ml-8">CONTACT</h1>
          ...
          <div className="w-4/5 h-full flex flex-col justify-center items-center sm:w-5/6">
            <input
              type="text"
              name="name"
              className="w-full h-1/7 text-3xl font-bold border-2 border-black cursor-none placeholder:text-black px-2 mb-4 ml-4 sm:text-6xl"
              placeholder="Name"
              value={formData.name}
            ...
            <input
              type="email"
              name="email"
              className="w-full h-1/7 text-3xl font-bold border-2 border-black cursor-none placeholder:text-black px-2 my-4 ml-4 sm:text-6xl"
              placeholder="Email"
